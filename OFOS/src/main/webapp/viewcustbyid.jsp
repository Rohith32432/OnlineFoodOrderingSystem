...
<body>
  ...
  <div class="container">
        ...
        <div class="content">
            <div class="data">
                <span class="data-label">ID:</span> ${cust.id}
            </div>
            <div class="data">
                <span class="data-label">Name:</span> ${cust.name}
            </div>
            <div class="data">
                <span class="data-label">Gender:</span> ${cust.gender}
            </div>
            <div class="data">
                <span class="data-label">DOB:</span> ${cust.dateofbirth}
            </div>
            <div class="data">
                <span class="data-label">Email:</span> ${cust.email}
            </div>
            <div class="data">
                <span class="data-label">Location:</span> ${cust.location}
            </div>
            <div class="data">
                <span class="data-label">Contact No:</span> ${rest.contact}
            </div>
        </div>
    </div>
</body>
