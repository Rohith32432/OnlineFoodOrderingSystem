...
public class Customer {
	...
	@Column(name="cust_dob",nullable=false,length = 20)
	private String dateofbirth;
	@Column(name="cust_location",nullable=false)
	...
	@Column(name="cust_contact",nullable=false,unique = true)
	...
	public String toString() {
		return "Customer [id=" + id + ", name=" + name + ", gender=" + gender + ", dateofbirth=" + dateofbirth
				+ ", location=" + location + ", email=" + email + ", password=" + password + ", contact=" + contact
				+ "]";
	}
